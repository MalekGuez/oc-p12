...
import { getUserData, getUserActivity, getUserAvgSessions, getUserPerformance,  } from '../services/dashboardService.js';

const Home = () => {
  const [fetchFromFile, setFetchFromFile] = useState(false);
  ...
  const fetchDataFromApi = async () => {
    ...
    const currentUserActivity = await getUserActivity(id);
    setUserActivity(currentUserActivity.sessions);

    const currentUserAvgSessions = await getUserAvgSessions(id);
    setUserAvgSessions(currentUserAvgSessions.sessions);
    ...
    const radarData = userPerformance.data.map(item => ({
